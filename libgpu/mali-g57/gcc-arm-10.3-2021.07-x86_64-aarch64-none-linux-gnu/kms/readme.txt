...
1.概述
本文用于说明在KMS图显系统上使用mali ddk库构建opengles和vulkan,请用户在使用前务必详细阅读本文档

2.GBM/DRM-KMS 图显系统
所谓的GBM/DRM-KMS 图显系统是指图形buffer的申请和bufferqueue的管理依赖于libgbm.so,
送显依靠libdrm.so和drm-kms显示驱动.
...
AW_PACKAGE_GPU_UM_PUB_DEFAULT_KMS=y
